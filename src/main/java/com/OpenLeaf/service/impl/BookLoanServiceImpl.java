...
import com.OpenLeaf.domain.BookLoanType;
...
import com.OpenLeaf.repository.BookRepository;
import com.OpenLeaf.repository.UserRepository;
import com.OpenLeaf.service.BookLoanService;
import com.OpenLeaf.service.FineCalculationService;
...
public class BookLoanServiceImpl implements BookLoanService {
    ...
    @Override
    public BookLoanDTO updateBookLoan(Long bookLoanId, com.OpenLeaf.payload.request.UpdateBookLoanRequest updateRequest) throws BookLoanException {
        // 1. Validate book loan exists
        BookLoan bookLoan = bookLoanRepository.findById(bookLoanId)
                .orElseThrow(() -> new BookLoanException("Book loan not found with id: " + bookLoanId));
